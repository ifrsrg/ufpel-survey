      ...
      for ( var i = 0; i < listaTratores.length; i++ ){
        ...
        divMoreInfo.innerHTML = textoParaAdd;
          ...
          if(divMoreInfo.style.display == 'none'){
            ...
            divBoxMaisEspec.innerHTML = "<i class='material-icons'>remove</i> ver menos especificações</span></span>";
          } else {
            divMoreInfo.style.display = 'none';
            divBoxMaisEspec.innerHTML = "<i class='material-icons'>add</i> ver mais especificacoes";
          }
        });
      }
    },
